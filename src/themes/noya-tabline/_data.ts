/**
 * noya-tabline（諾亞極簡側線/頂分頁）共用資料
 *
 * 移植自設計稿 ly10：極簡側線（手機）/ 頂部分頁（桌面）
 * 類別限定 live（真人視訊），卡片扁平描邊風格
 * assets 沿用 noya-blue 切片
 */
 ...
 * 各分類遊戲卡（三層合成卡）
 *
 * ly10 卡片扁平描邊：box-shadow:none; border:1px solid var(--line)
 */
