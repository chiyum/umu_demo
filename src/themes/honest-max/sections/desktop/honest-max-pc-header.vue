...
<template>
  <header class="honest-max-pc-header">
    <div class="honest-max-pc-header__inner">
      <a class="honest-max-pc-header__brand" href="#" :aria-label="logoLabel">
        <img
          :src="logoSrc"
          :alt="logoLabel"
          class="honest-max-pc-header__logo"
          :class="{ 'honest-max-pc-header__logo--blend': useScreenBlend }"
        />
      </a>

      <nav class="honest-max-pc-header__nav" aria-label="主導覽">
        <div
          v-for="cat in NAV_CATEGORIES"
          :key="cat.key"
          class="honest-max-pc-header__cat"
        >
          <span class="honest-max-pc-header__cat-label">{{ cat.label }}</span>
          <div class="honest-max-pc-header__sub">
            <span
              v-for="item in cat.subItems"
              :key="item"
              class="honest-max-pc-header__sub-item"
            >
              {{ item }}
            </span>
          </div>
      ...
      <div class="honest-max-pc-header__actions">
        <button
          type="button"
          class="honest-max-pc-header__btn honest-max-pc-header__btn--log"
        >
          登入
        </button>
        <button
          type="button"
          class="honest-max-pc-header__btn honest-max-pc-header__btn--reg"
        >
          註冊
        </button>
      </div>
