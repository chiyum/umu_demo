/**
 * noya-jade（翡翠綠金）共用資料 + 資產
 *
 * 深色翡翠綠金玻璃風格，沿用諾亞娛樂品牌文案，
 * live 分類使用真實 DG / 歐博切片，其他分類使用綠漸層佔位卡。
 */
...
export const LOBBY_CARDS: Record<string, LobbyCard[]> = {
  live: [
    { img: cardDgSrc, alt: "DG真人 DG CASINO", badge: "HOT" },
    { img: cardAllbetSrc, alt: "歐博真人 ALLBET CASINO", badge: "NEW" },
    { img: cardDgSrc, alt: "DG真人 DG CASINO" }
  ],
  sport: [
    { big: "鑫寶體育", sub: "SHINBO SPORTS", wm: "SPORTS", badge: "HOT" },
    { big: "熊貓體育", sub: "PANDA SPORTS", wm: "SPORTS" }
  ],
  chess: [
    { big: "開元棋牌", sub: "KAIYUAN CHESS", wm: "POKER", badge: "HOT" },
    { big: "博雅棋牌", sub: "BOYAA POKER", wm: "POKER" }
  ],
  slot: [
    { big: "PG 電子", sub: "PG SLOT", wm: "SLOT", badge: "NEW" },
    { big: "PT 電子", sub: "PT SLOT", wm: "SLOT" },
    { big: "MG 電子", sub: "MG SLOT", wm: "SLOT" }
  ],
  fish: [
    { big: "捕魚達人", sub: "FISHING MASTER", wm: "FISHING", badge: "HOT" },
