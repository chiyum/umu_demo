/**
 * noya-rhombus（諾亞斜切菱形）共用資料 + 資產
 *
 * 移植自設計稿 ly4 斜切平行四邊形版型。
 * 色調梅紫（plum）為主，亮色系（brightness=light）。
 * 真人視訊分類為主（categories=["live"]）。
 */

/** hero banner（沿用 noya-blue 的 hero 切片） */
 ...
 *
 * - 真人（live）：提供 name/en/tag 供三層合成卡渲染
 * - 其他分類：同三層合成卡，g-fig 用 .ph 佔位
 */
